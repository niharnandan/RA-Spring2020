...
############################### Explanation ###############################
# This is a very similar code to 'data simulation.py'. But instead of simulating 40*25 sequences,
# we simulate 100 samples, each with 25*4 sequences. We will calculate the distribution of MLE
...
# NOTE 3: write into csv file called 'simulation results 2.csv'
...
# output: prob of choosing stop, investigate 1, and investigate 2
...
# write simulation results into one single file
with open('simulation results 2.csv','w') as csvfile:
...
for M in range(100): 
    ...
    for c in cost:
        ...
        for p in prior:
            ...
            for i in range(4): # four simulations
                ...
                with open('simulation results 2.csv','a') as csvfile:
