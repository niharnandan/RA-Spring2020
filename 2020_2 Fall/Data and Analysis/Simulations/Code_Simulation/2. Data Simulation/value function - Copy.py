...
alpha_1 = int(content_list[0]) # update in the direction of more likely
alpha_2 = int(content_list[1]) # update in the direction of less likely
...
stop_cost = int(content_list[5]) # stop cost
reward = int(content_list[6]) # reward for getting the right state
number = int(content_list[7]) # number of grids
